...
static __devinit int samsung_wm8994_driver_probe(struct platform_device *pdev)
{
	int ret;
...
static int __devexit samsung_wm8994_driver_remove(struct platform_device *pdev)
{
	snd_soc_unregister_card(&smdk);
	platform_set_drvdata(pdev, NULL);
	return 0;
}
		
static struct platform_driver samsung_wm8994_driver = {
        .driver = {
                .name = "SOC-AUDIO-SAMSUNG",
                .owner = THIS_MODULE,
        },
        .probe = samsung_wm8994_driver_probe,
        .remove = __devexit_p(samsung_wm8994_driver_remove),
};
module_platform_driver(samsung_wm8994_driver);
