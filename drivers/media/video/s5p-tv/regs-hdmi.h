...
/*HDCP registers*/
#define S5P_HDMI_HDCP_RX_SHA1_0_0		HDMI_CORE_BASE(0x7000)
#define S5P_HDMI_HDCP_RX_SHA1_0_1		HDMI_CORE_BASE(0x7004)
#define S5P_HDMI_HDCP_RX_SHA1_0_2		HDMI_CORE_BASE(0x7008)
#define S5P_HDMI_HDCP_RX_SHA1_0_3		HDMI_CORE_BASE(0x700c)
#define S5P_HDMI_HDCP_RX_SHA1_1_0		HDMI_CORE_BASE(0x7010)
#define S5P_HDMI_HDCP_RX_SHA1_1_1		HDMI_CORE_BASE(0x7014)
#define S5P_HDMI_HDCP_RX_SHA1_1_2		HDMI_CORE_BASE(0x7018)
#define S5P_HDMI_HDCP_RX_SHA1_1_3		HDMI_CORE_BASE(0x701c)
#define S5P_HDMI_HDCP_RX_SHA1_2_0		HDMI_CORE_BASE(0x7020)
#define S5P_HDMI_HDCP_RX_SHA1_2_1		HDMI_CORE_BASE(0x7024)
#define S5P_HDMI_HDCP_RX_SHA1_2_2		HDMI_CORE_BASE(0x7028)
#define S5P_HDMI_HDCP_RX_SHA1_2_3		HDMI_CORE_BASE(0x702c)
#define S5P_HDMI_HDCP_RX_SHA1_3_0		HDMI_CORE_BASE(0x7030)
#define S5P_HDMI_HDCP_RX_SHA1_3_1		HDMI_CORE_BASE(0x7034)
#define S5P_HDMI_HDCP_RX_SHA1_3_2		HDMI_CORE_BASE(0x7038)
#define S5P_HDMI_HDCP_RX_SHA1_3_3		HDMI_CORE_BASE(0x703c)
#define S5P_HDMI_HDCP_RX_SHA1_4_0		HDMI_CORE_BASE(0x7040)
#define S5P_HDMI_HDCP_RX_SHA1_4_1		HDMI_CORE_BASE(0x7044)
#define S5P_HDMI_HDCP_RX_SHA1_4_2		HDMI_CORE_BASE(0x7048)
#define S5P_HDMI_HDCP_RX_SHA1_4_3		HDMI_CORE_BASE(0x704c)

#define S5P_HDMI_HDCP_RX_KSV_0_0		HDMI_CORE_BASE(0x7050)
#define S5P_HDMI_HDCP_RX_KSV_0_1		HDMI_CORE_BASE(0x7054)
#define S5P_HDMI_HDCP_RX_KSV_0_2		HDMI_CORE_BASE(0x7058)
#define S5P_HDMI_HDCP_RX_KSV_0_3		HDMI_CORE_BASE(0x705c)
#define S5P_HDMI_HDCP_RX_KSV_0_4		HDMI_CORE_BASE(0x7060)

#define S5P_HDMI_HDCP_KSV_LIST_CON		HDMI_CORE_BASE(0x7064)
#define S5P_HDMI_HDCP_SHA_RESULT		HDMI_CORE_BASE(0x7070)
#define S5P_HDMI_HDCP_CTRL1			HDMI_CORE_BASE(0x7080)
#define S5P_HDMI_HDCP_CTRL2			HDMI_CORE_BASE(0x7084)
#define S5P_HDMI_HDCP_CHECK_RESULT		HDMI_CORE_BASE(0x7090)

#define S5P_HDMI_HDCP_BKSV_0_0			HDMI_CORE_BASE(0x70a0)
#define S5P_HDMI_HDCP_BKSV_0_1			HDMI_CORE_BASE(0x70a4)
#define S5P_HDMI_HDCP_BKSV_0_2			HDMI_CORE_BASE(0x70a8)
#define S5P_HDMI_HDCP_BKSV_0_3			HDMI_CORE_BASE(0x70ac)
#define S5P_HDMI_HDCP_BKSV_1			HDMI_CORE_BASE(0x70b0)

#define S5P_HDMI_HDCP_AKSV_0_0			HDMI_CORE_BASE(0x70c0)
#define S5P_HDMI_HDCP_AKSV_0_1			HDMI_CORE_BASE(0x70c4)
#define S5P_HDMI_HDCP_AKSV_0_2			HDMI_CORE_BASE(0x70c8)
#define S5P_HDMI_HDCP_AKSV_0_3			HDMI_CORE_BASE(0x70cc)
#define S5P_HDMI_HDCP_AKSV_1			HDMI_CORE_BASE(0x70d0)

#define S5P_HDMI_HDCP_An_0_0			HDMI_CORE_BASE(0x70e0)
#define S5P_HDMI_HDCP_An_0_1			HDMI_CORE_BASE(0x70e4)
#define S5P_HDMI_HDCP_An_0_2			HDMI_CORE_BASE(0x70e8)
#define S5P_HDMI_HDCP_An_0_3			HDMI_CORE_BASE(0x70ec)
#define S5P_HDMI_HDCP_An_1_0			HDMI_CORE_BASE(0x70f0)
#define S5P_HDMI_HDCP_An_1_1			HDMI_CORE_BASE(0x70f4)
#define S5P_HDMI_HDCP_An_1_2			HDMI_CORE_BASE(0x70f8)
#define S5P_HDMI_HDCP_An_1_3			HDMI_CORE_BASE(0x70fc)

#define S5P_HDMI_HDCP_BCAPS			HDMI_CORE_BASE(0x7100)
#define S5P_HDMI_HDCP_BSTATUS_0			HDMI_CORE_BASE(0x7110)
#define S5P_HDMI_HDCP_BSTATUS_1			HDMI_CORE_BASE(0x7114)
#define S5P_HDMI_HDCP_Ri_0			HDMI_CORE_BASE(0x7140)
#define S5P_HDMI_HDCP_Ri_1			HDMI_CORE_BASE(0x7144)
#define S5P_HDMI_HDCP_I2C_INT			HDMI_CORE_BASE(0x7180)
#define S5P_HDMI_HDCP_AN_INT			HDMI_CORE_BASE(0x7190)
#define S5P_HDMI_HDCP_WDT_INT			HDMI_CORE_BASE(0x71a0)
#define S5P_HDMI_HDCP_RI_INT			HDMI_CORE_BASE(0x71b0)

#define S5P_HDMI_HDCP_RI_COMPARE_0		HDMI_CORE_BASE(0x71d0)
#define S5P_HDMI_HDCP_RI_COMPARE_1		HDMI_CORE_BASE(0x71d4)
#define S5P_HDMI_HDCP_FRAME_COUNT		HDMI_CORE_BASE(0x71e0)
#define S5P_HDMI_GCP_CON			HDMI_CORE_BASE(0x200)
#define S5P_HDMI_HDCP_KEY_LOAD			HDMI_CTRL_BASE(0x0008)
...
/* HDMIE-FUSEregiseter */
#define S5P_HDMI_EFUSE_CTRL			HDMI_EFUSE_BASE(0x000)
#define S5P_HDMI_EFUSE_STATUS			HDMI_EFUSE_BASE(0x004)
#define S5P_HDMI_EFUSE_ADDR_WIDTH		HDMI_EFUSE_BASE(0x008)
#define S5P_HDMI_EFUSE_SIGDEV_ASSERT		HDMI_EFUSE_BASE(0x00c)
#define S5P_HDMI_EFUSE_SIGDEV_DEASSERT		HDMI_EFUSE_BASE(0x010)
#define S5P_HDMI_EFUSE_PRCHG_ASSERT		HDMI_EFUSE_BASE(0x014)
#define S5P_HDMI_EFUSE_PRCHG_DEASSERT		HDMI_EFUSE_BASE(0x018)
#define S5P_HDMI_EFUSE_FSET_ASSERT		HDMI_EFUSE_BASE(0x01c)
#define S5P_HDMI_EFUSE_FSET_DEASSERT		HDMI_EFUSE_BASE(0x020)
#define S5P_HDMI_EFUSE_SENSING			HDMI_EFUSE_BASE(0x024)
#define S5P_HDMI_EFUSE_SCK_ASSERT		HDMI_EFUSE_BASE(0x028)
#define S5P_HDMI_EFUSE_SCK_DEASSERT		HDMI_EFUSE_BASE(0x02c)
#define S5P_HDMI_EFUSE_SDOUT_OFFSET		HDMI_EFUSE_BASE(0x030)
#define S5P_HDMI_EFUSE_READ_OFFSET		HDMI_EFUSE_BASE(0x034)
