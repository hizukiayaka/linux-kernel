/* linux/drivers/media/video/fimg2d/fimg2d4x_hw.c
 *
 ...
 *
 * MODE:		Formula with Global Alpha (Ga is multiplied to both Sc
 *			and Sa)
 * ----------------------------------------------------------------------------
 * FILL:
 * CLEAR:	     R = 0
 ...
 * DST_ATOP:         R = (1-Da)*Ga*Sc + Sa*Ga*Dc --> (W/A) 1st: Ga*Sc,
 *			2nd:DST_ATOP
 * XOR:              R = (1-Da)*Ga*Sc + (1-Sa*Ga)*Dc --> (W/A) 1st: Ga*Sc,
 *			2nd:XOR
 * ADD:              R = Ga*Sc + Dc
